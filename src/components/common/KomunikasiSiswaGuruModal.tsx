            ...
            <form onSubmit={handleKirimPesan} className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 p-3.5 bg-purple-50/60 rounded-2xl border border-purple-200">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full text-xs font-semibold px-3 py-2 rounded-xl bg-white border border-slate-200 focus:outline-none focus:border-purple-500"
                    >
                      {kelasList.map((k) => (
              ...
              {isSiswa && (
                <div className="p-3.5 bg-indigo-50/60 rounded-2xl border border-indigo-200">
                  ...
                  <select
                    ...
                    className="w-full text-xs font-semibold px-3 py-2 rounded-xl bg-white border border-slate-200 focus:outline-none focus:border-indigo-500"
                  >
                    {stafList.map((st) => (
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full text-xs font-semibold px-3.5 py-2.5 rounded-xl border border-slate-200 focus:outline-none focus:border-purple-500"
                  required
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full text-xs leading-relaxed p-3.5 rounded-2xl border border-slate-200 focus:outline-none focus:border-purple-500"
                  required
                />
              </div>
