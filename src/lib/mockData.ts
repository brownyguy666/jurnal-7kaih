...
export const INITIAL_KEBIASAAN: Kebiasaan[] = [
  ...
  },
  {
    ...
    nama: 'Beribadah',
    urutan: 2,
    deskripsi: 'Melaksanakan sholat 5 waktu tepat pada rentang waktunya (Subuh 04.00-05.45, Dzuhur 11.30-14.45, Ashar 15.00-17.30, Maghrib 17.30-18.45, Isya 18.45-23.59 WIB).',
    jam_mulai: null,
    jam_selesai: null,
    toleransi_menit: 15,
    maks_input_harian: 5,
    butuh_sub_tipe: true,
    daftar_sub_tipe: ['Subuh', 'Dzuhur', 'Ashar', 'Maghrib', "Isya'"],
    butuh_nama_kegiatan: false,
